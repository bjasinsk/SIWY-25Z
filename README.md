# SIWY-25Z-Jarczewski-Rozej-Jasinski

Repozytorium przeznaczone na realizację projektu z przedmiotu [SIWY] Wyjaśnialna sztuczna inteligencja w semestrze 25Z.
...
│                         siwy and configuration for tools like black
│
...
│
└── siwy   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes siwy a Python module
    │
