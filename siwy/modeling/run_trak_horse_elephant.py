...
# TODO: create HorseElephantConfig and import from there
# from siwy.datasets.HorseElephantConfig import HORSE_AND_ELEPHANT_MODEL_ARTIFACT_TEMPLATE, CLASS_TO_IDX
...
# Placeholder values since config is missing
CLASS_TO_IDX = {
    "Horse": 0,
    "Elephant": 1,
    "Airplane": 2,
}
HORSE_AND_ELEPHANT_MODEL_ARTIFACT_TEMPLATE = "jarcin/SIWY-25Z/horse-elephant-TODO:v0"
...
def main(
    ...
    batch_size = 32
    num_classes = 3
    dataset = "horse-and-elephant-easy-train"
    ...
    with wandb.init(project="SIWY-25Z", job_type="trak") as run:
        ...
        # --- LOAD CHECKPOINTS ---
        for epoch in epochs:
            artifact = run.use_artifact(HORSE_AND_ELEPHANT_MODEL_ARTIFACT_TEMPLATE.format(epoch), type="model")
